...
<div id="rightSide">
    ...
    <div class="resp">
        ...
        <div class="smalldd">
            ...
            <ul class="smallDropdown">
                <li><a href="#" title=""><img src="{{ URL::asset('images/icons/light/home.png') }}" alt="" />Dashboard</a></li>
                <li><a href="charts.html" title=""><img src="{{ URL::asset('images/icons/light/stats.png') }}" alt="" />Statistics and charts</a></li>
                <li><a href="#" title="" class="exp"><img src="{{ URL::asset('images/icons/light/pencil.png') }}" alt="" />Forms stuff<strong>4</strong></a>
                    <ul>
                ...
                <li><a href="ui_elements.html" title=""><img src="{{ URL::asset('images/icons/light/users.png') }}" alt="" />Interface elements</a></li>
                <li><a href="tables.html" title="" class="exp"><img src="{{ URL::asset('images/icons/light/frames.png') }}" alt="" />Tables<strong>3</strong></a>
                    <ul>
                ...
                <li><a href="#" title="" class="exp"><img src="{{ URL::asset('images/icons/light/fullscreen.png') }}" alt="" />Widgets and grid<strong>2</strong></a>
                    <ul>
                        <li><a href="widgets.html" title="">Widgets</a></li>
                        <li class="last"><a href="grid.html" title="">Grid</a></li>
                    </ul>
                </li>
                <li><a href="#" title="" class="exp"><img src="{{ URL::asset('images/icons/light/alert.png') }}" alt="" />Error pages<strong>6</strong></a>
                    <ul class="sub">
                ...
                <li><a href="file_manager.html" title=""><img src="{{ URL::asset('images/icons/light/files.png') }}" alt="" />File manager</a></li>
                <li><a href="#" title="" class="exp"><img src="{{ URL::asset('images/icons/light/create.png') }}" alt="" />Other pages<strong>3</strong></a>
                    <ul>
    ...
    <div class="wrapper">
        ...
        <div class="widget chartWrapper">
            <div class="title"><img src="{{ URL::asset('images/icons/dark/stats.png') }}" alt="" class="titleIcon" /><h6>Chart</h6></div>
        ...
        <div class="widgets">
            <div class="oneTwo">
                ...
                <div class="widget">
                    <div class="title"><img src="{{ URL::asset('images/icons/dark/users.png') }}" alt="" class="titleIcon" /><h6>Partners list</h6></div>
                    <ul class="partners">
                        <li>
                            <a href="#" title="" class="floatL"><img src="{{ URL::asset('images/user.png') }}" alt="" /></a>
                            <div class="pInfo">
                                <a href="#" title=""><strong>Dave Armstrong</strong></a>
                                <i>Creative director at Google Inc. Zurich</i>  
                            </div>
                            <div class="pLinks">
                                <a href="#" title="Direct call" class="tipW"><img src="{{ URL::asset('images/icons/pSkype.png') }}" alt="" /></a>
                                <a href="#" title="Send an email" class="tipW"><img src="{{ URL::asset('images/icons/pEmail.png') }}" alt="" /></a>
                            </div>
                            <div class="clear"></div>
                        </li>
                        <li>
                ...
                <div class="widget">
                    <div class="title"><img src="{{ URL::asset('images/icons/dark/stats.png') }}" alt="" class="titleIcon" /><h6>Website statistics</h6></div>
                ...
                <div class="widget">
                    <div class="title"><img src="{{ URL::asset('images/icons/dark/refresh4.png') }}" alt="" class="titleIcon" /><h6>Latest updates</h6></div>
            ...
            <div class="oneTwo">
                ...
                <div class="widget">
                    <div class="title">
                        <img src="{{ URL::asset('images/icons/dark/money.png') }}" alt="" class="titleIcon" />
                        <h6>Purchase info</h6>
                        <div class="topIcons">
                            <a href="#" class="tipS" title="Download statement"><img src="{{ URL::asset('images/icons/downloadTop.png') }}" alt="" /></a>
                            <a href="#" class="tipS" title="Print invoice"><img src="{{ URL::asset('images/icons/printTop.png') }}" alt="" /></a>
                            <a href="#" class="tipS" title="Edit"><img src="{{ URL::asset('images/icons/editTop.png') }}" alt="" /></a>
                        </div>
                    </div>
                    <div class="newOrder">
                        <div class="userRow">
                            <a href="#" title=""><img src="{{ URL::asset('images/user.png') }}" alt="" class="floatL" /></a>
                            <ul class="leftList">
                ...
                <!-- New users widget -->
                <div class="widget">
                    <div class="title"><img src="{{ URL::asset('images/icons/dark/add.png') }}" alt="" class="titleIcon" /><h6>New users</h6></div>
                    <div class="wUserInfo">
                        <a href="#" title="" class="wUserPic"><img src="{{ URL::asset('images/user.png') }}" alt="" /></a>
                        <ul class="leftList">
                ...
                <div class="widget">
                    <div class="title"><img src="{{ URL::asset('images/icons/dark/timer.png') }}" alt="" class="titleIcon" /><h6>My tasks</h6><div class="num"><a href="#" class="blueNum">+245</a></div></div>
                    <table cellpadding="0" cellspacing="0" width="100%" class="sTable taskWidget">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="actBtns"><a href="#" title="Update" class="tipS"><img src="{{ URL::asset('images/icons/edit.png') }}" alt="" /></a><a href="#" title="Remove" class="tipS"><img src="{{ URL::asset('images/icons/remove.png') }}" alt="" /></a></td>
                            </tr>
                            <tr>
        ...
        <!-- Events calendar -->
        <div class="widget">
            <div class="title"><img src="{{ URL::asset('images/icons/dark/monthCalendar.png') }}" alt="" class="titleIcon" /><h6>Events</h6></div>
        ...
        <div class="widget">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                <thead>
                    <tr>
                        <td><img src="{{ URL::asset('images/icons/tableArrows.png') }}" alt="" /></td>
                        <td>Image</td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="center"><a href="images/big.png" title="" rel="lightbox"><img src="{{ URL::asset('images/user.png') }}" alt="" /></a></td>
        ...
        <!-- Dynamic table -->
        <div class="widget">
            <div class="title"><img src="{{ URL::asset('images/icons/dark/full2.png') }}" alt="" class="titleIcon" /><h6>Dynamic table</h6></div>                          
